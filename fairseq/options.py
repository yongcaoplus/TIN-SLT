...
def get_terminal_generation_parser(interactive=False, default_task='translation'):
...
def parse_args_and_arch(parser, search_space_params, input_args=None, parse_known=False):
...
def add_optimization_args(parser):
    ...
    group.add_argument("--dataset_path", default="", type=str,
                       help='choose whether to use cosine alpha params')
    # fmt: on
    return group
