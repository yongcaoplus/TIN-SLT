...
def load_model_ensemble(filenames, arg_overrides=None, task=None, bert_ratio=None, encoder_ratio=None, geargs=None):
    ...
    for filename in filenames:
        ...
        if geargs is not None:
            ...
            if hasattr(geargs, 'instruction_layer_num'):
                setattr(args, 'instruction_layer_num', geargs.instruction_layer_num)
            if hasattr(geargs, 'alpha_mode'):
                setattr(args, 'alpha_mode', geargs.alpha_mode)
